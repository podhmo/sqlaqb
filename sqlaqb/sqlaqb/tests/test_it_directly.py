...
class Tests(unittest.TestCase):
    ...
    def test_missing(self):
        ...
        with self.assertRaisesRegexp(InvalidContract, "is empty"):
            self._callFUT(Base, {})
    ...
    def test_same_base_twice__same(self):
        ...
        self.assertEquals(models1, models2)
    ...
    def test_other_base_twice__different(self):
        ...
        self.assertNotEquals(models1, models2)
        self.assertNotEquals(models1.Group, models2.Group)
    ...
    def test_single__missing_depends(self):
        ...
        with self.assertRaisesRegexp(InvalidContract, "Group is missing"):
